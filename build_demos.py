    ...
    product_html = """
        ...
        <div class="container" style="max-width: 1400px !important; width: 100% !important; box-sizing: border-box !important; margin: 30px auto 0 !important; padding: 0 16px !important;">
            ...
            <style>
                ...
                /* Price animation & visual feedback */
                @keyframes priceBump {
                    0% { transform: scale(1); filter: drop-shadow(0 0 0px var(--primary)); }
                    50% { transform: scale(1.08); filter: drop-shadow(0 0 10px rgba(30, 58, 138, 0.5)); color: #10b981; }
                    100% { transform: scale(1); filter: drop-shadow(0 0 0px var(--primary)); }
                }
                .price-bump-animation {
                    animation: priceBump 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94);
                    display: inline-block;
                }
            ...
            <div class="nava-product-layout" style="margin-bottom: 60px;">
                ...
                <div class="nava-prod-info">
                    ...
                    <div class="product-actions-container">
                        ...
                        <!-- Secondary THÊM VÀO GIỎ Button -->
                        <button class="btn-add-to-cart-secondary" id="btn-add-cart-main">
                            THÊM VÀO GIỎ
                        </button>
  ...
  <iframe allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="" frameborder="0" height="315" referrerpolicy="strict-origin-when-cross-origin" src="https://www.youtube.com/embed/_er1aM1m2Ho?si=eHqkesK0LAb_zM1k" title="YouTube video player" width="560">
            ...
            <script>
                ...
                function selectVariantDropdown(element, type, price, name) {
                    ...
                    if (mainPrice) {
                        mainPrice.innerHTML = total.toLocaleString('vi-VN') + '₫';
                        mainPrice.classList.remove('price-bump-animation');
                        void mainPrice.offsetWidth; // Force reflow
                        mainPrice.classList.add('price-bump-animation');
                    }
                    const stickyPrice = document.getElementById('sticky-price');
                    if(stickyPrice) {
                        stickyPrice.innerHTML = total.toLocaleString('vi-VN') + '₫';
                        stickyPrice.classList.remove('price-bump-animation');
                        void stickyPrice.offsetWidth; // Force reflow
                        stickyPrice.classList.add('price-bump-animation');
                    }
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    const btnAddCartMain = document.getElementById('btn-add-cart-main');
                    if (btnAddCartMain) {
                        btnAddCartMain.addEventListener('click', triggerCartOpen);
                    }
