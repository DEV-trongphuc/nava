...
new_shopee_api_url = "const shopeeApiUrl = '/api/shopee-reviews';"
new_shopee_summary_url = "const shopeeSummaryUrl = '/api/shopee-summary';"
...
with open('assets/main.js', 'w', encoding='utf-8') as f:
    f.write(js_content)
print("Updated API URLs to use Vercel rewrite paths.")
