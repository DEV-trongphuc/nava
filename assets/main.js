document.addEventListener('DOMContentLoaded', () => {
    ...
    if (shopeeList) {
        const shopeeApiUrl = 'https://api.codetabs.com/v1/proxy?quest=https://shopee.vn/api/v4/seller_operation/get_shop_ratings_new?userid=65858058&shopid=65856601&limit=10&offset=0&replied=undefined';
